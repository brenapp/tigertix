...
const EventPage: NextPage<{ event: Event }> = ({ event }) => {
    ...
    return (
        <Container>
            ...
            />
            <main className="pt-4 md:px-4 grid lg:grid-cols-6 lg:gap-4 grid-cols-1">
                <section className="image relative max-w-screen-xl mx-auto lg:col-span-4">
                    <Image
                ...
                <section className="info bg-white rounded-md flex-1 border-2 p-4 lg:col-span-2 md:m-0 m-2">
