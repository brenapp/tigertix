...
const EventCreateForm = () => {
    ...
    const pages: [string, JSX.Element][] = [
        [
            "Basic Details",
            <>
                <section className="bg-white rounded-md border-2 px-4 py-2 col-span-4">
                    ...
                    <div className="form-group grid lg:grid-cols-3 lg:gap-2 col-span-2">
                        ...
                        <p className="lg:mt-6 ml-2 italic text-sm">
                            The event description should be a brief,
                            one-sentence overview of your event. You can enter
                            more information in the content blocks below.{" "}
                        </p>
                    </div>
                </section>
                <EventPreview />
    ...
    return (
        <section className="create grid lg:grid-cols-6 gap-2 ">
            <nav className="col-span-6 bg-white h-16 border-2 rounded-md flex justify-center items-center">
                {pages.map(([title], i) => (
                    <a
                        className={
                            "mx-4 text-orange " +
